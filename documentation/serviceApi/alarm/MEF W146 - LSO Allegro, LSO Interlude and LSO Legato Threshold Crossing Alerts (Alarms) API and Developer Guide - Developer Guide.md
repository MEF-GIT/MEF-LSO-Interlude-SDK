...
The Alarm Management API is defined using OpenAPI 3.0 
[[OAS-V3](#8-references)]
...
- MEF W133.1 _Allegro, Interlude and Legato Alarm Management  BR&UC_ [[MEF W133.1](#8-references)]
...
The Buyer/Client can retrieve a list of `Alarm_Find` by using a 
...
**[R19]** In case `id` does not allow finding a `Alarm` in 
...
**[R27]** The Seller/Server **MUST** send Alarms to the Buyer/Client that 
...
![Figure 15: Alarm Data Model](media/alarmDataModel.png)
