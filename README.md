# Mplify-LSO-Interlude-SDK Kylie Release

## Download Link

Download the entire repository by clicking
[here](https://github.com/MEF-GIT/MEF-LSO-Interlude-SDK/releases/download/kylie/Mplify-LSO-Interlude-SDK-kylie.zip)
...
LSO Interlude Interface Reference Point (IRP) as defined in the Mplify LSO
...
The Mplify LSO Interlude SDK is released under the Apache 2.0 license.

More information about the LSO Interlude API reference point and its roadmap can
be found here:

https://wiki.mplify.net/display/CESG/LSO+Interlude
